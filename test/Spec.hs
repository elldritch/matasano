...
main = do
  ...
  s1q6data <- readFile "test/1-6-data"
  s1q7data <- readFile "test/1-7-data"
  s1q8data <- readFile "test/1-8-data"
  ...
  hspec $ do
    describe "Set 1: Basics" $ do
      ...
      let q2 = qs !! 1
      it "2. Fixed XOR" $
        q2 ["1c0111001f010100061a024b53535009181c", "686974207468652062756c6c277320657965"]
          `shouldBe` "746865206b696420646f6e277420706c6179"

      let q3  = qs !! 2
      it "3. Single-byte XOR cipher" $
        q3 ["1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"]
          `shouldBe` "Cooking MC's like a pound of bacon"
